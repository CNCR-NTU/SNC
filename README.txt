Model Controller Software

### Application ###

* MCS version: 1.0
* XML2HexLib version: 1.3
...
* ThreadsDef.py - provides the services from the MCS
* ResultsUpload.py - provides the services to synchronise with the RUS
